...
public class CostumAdapter extends RecyclerView.Adapter<CostumAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView2 = (TextView) v.findViewById(R.id.tempat);
            textView3 = (TextView) v.findViewById(R.id.pukul);
            textView4 = (TextView) v.findViewById(R.id.tanggal);
     ...
     */
    public CostumAdapter(String[] dataSet, String[] dataSet2, String[] dataSet3, String[] dataSet4, int[] dataSet5) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.sholat_list_view, viewGroup, false);
